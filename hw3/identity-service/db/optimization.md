...
Кол-во строк в таблице **users_auth**:
```
users_auth	10012
```

Кол-во строк в таблице **users_profile**:
```
users_profile	10012
```
